...
<!DOCTYPE html>
    ...
    <body>
    <h1 style="text-align: center; color: green;">CRUD operations along with importing and exporting data using Excel</h1>
    ...
    <div class="row">
        <div class="col-md-4">
        <button id="addItemButton" class="btn btn-primary" style="width: 150px; height: 50px;">Add Item</button><br><br>

            <input type="text" id="livesearch" placeholder="Search title or description" style="width: 400px; height: 60px;">
...
<?php /**PATH /var/www/html/crud_new/crud/resources/views/crud.blade.php ENDPATH**/ ?>